...
export const SearchBar: React.FC<searchBar> = function ({
    state, setState
}) {
    ...
    return (
        <section className="flex gap-5">
            ...
            <div className="w-full rounded-md text-sm bg-mainWhiteShade p-8 py-5 gap-5 font-medium flex">
                ...
                <input type={"text"} className="bg-mainWhiteShade outline-none w-full text-xs lg:text-sm" placeholder="Search transaction"
                    onChange={(e) => {
                        if (state) {
