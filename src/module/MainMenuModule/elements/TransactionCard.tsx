    ...
    return (
        <>
            ...
            <div
                ...
                className="w-full bg-mainWhiteShade duration-500 hover:scale-[101%] hover:bg-mainWhite rounded-xl flex items-center p-5 lg:px-8 lg:py-5">

                <div className="min-w-[3rem] h-[3rem] flex items-center justify-center bg-mainWhite rounded-full mr-[23%] sm:mr-[33%]">
                    <Image src={`/${item.category.toLowerCase()}.svg`} alt="" width={22} height={22} className="" />
                </div>

                <div className="flex flex-col mr-[20px] flex-grow sm:max-w-[20rem] sm:mr-auto">
                    <h1 className="font-bold text-sm line-clamp-1 overflow-ellipsis">{item.name}</h1>
                    <h3 className="font-semibold text-[#95979D] text-xs sm:text-sm ">{dateString}</h3>
